...
function copyWithoutIndices(arr, indices) {
  let excludedSet;
...
const otherArgs = copyWithoutIndices(args, watchFileIndex);
...
window.addEventListener('visibilitychange', ()=>{
  ...
  editWarning: (
`<!--############################################################################
# WARNING: DO NOT EDIT THIS FILE. EDIT ${templateFileName} INSTEAD,            #
#   THEN USE "node compileTemplate ${templateFileName}" FROM THE COMMAND LINE! #
#############################################################################-->`)
});
